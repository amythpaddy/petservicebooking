...
/// push [CardDatePickerDialog] when the button is tapped.
///
/// ```dart
...
Future<DateTime?> showCustomDatePicker({
  ...
  Widget dialog = CardDatePickerDialog(
...
class CardDatePickerDialog extends StatefulWidget {
  ...
  /// Restoration ID to save and restore the state of the [CardDatePickerDialog].
  ///
