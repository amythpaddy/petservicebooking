        ...
        children: [
          Expanded(
            child: SingleChildScrollView(
              child: Container(
                margin:
                    EdgeInsets.symmetric(horizontal: 19.36, vertical: 24.59),
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                          ...
                          return Column(
                            children: [
                              ...
                              ListTile(
                                  ...
                                  onTap: () {
                                    onPaymentMethodSelected
                                        .onPaymentMethodChange(blocContext,
          ...
          BlocBuilder<PaymentSelectionBloc, PaymentSelectionState>(
            ...
            return Container(
                padding:
                    EdgeInsets.symmetric(horizontal: 18.38, vertical: 12.5),
                width: SizeConfig.screenWidth,
                color: state.paymentMethod == PAYMENT_METHOD.ONLINE
                    ? Color(0xFFE4EEE9)
                    : Color(0xFFF3EBEB),
                child: Text(
                  state.paymentMethod == PAYMENT_METHOD.ONLINE
                      ? 'Rs. 10,000 insurance on online payment'
                      : 'No insurance on cash payment',
                  style: TextStyle(
